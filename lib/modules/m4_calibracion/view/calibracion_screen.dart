      ...
      body: ListView(
        ...
        children: [
          ...
          Card(
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Text('Patron bajo: ${estado.caso.patronBajo} ${estado.caso.rango.magnitud.simbolo}'),
                  Text('Patron alto: ${estado.caso.patronAlto} ${estado.caso.rango.magnitud.simbolo}'),
          ...
          ElevatedButton.icon(
            ...
            label: const Text('Medir ambos patrones (25 lecturas c/u) y calibrar'),
            ...
            Card(
              child: Padding(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('Promedio en patron bajo: ${estado.promedioBajo!.toStringAsFixed(4)}'),
                    Text('Promedio en patron alto: ${estado.promedioAlto!.toStringAsFixed(4)}'),
                    const Divider(),
                    Text('Ganancia estimada: ${estado.estimada!.ganancia.toStringAsFixed(4)} (ideal 1.0000)'),
                    Text('Offset estimado: ${estado.estimada!.offset.toStringAsFixed(4)} (ideal 0.0000)'),
                  ],
                ),
              ),
            ),
